  ...
  return (
    <>
      <div className="flex flex-col bg-brand-500/5 shadow-brand-card hover:shadow-brand hover:scale-[1.01] duration-300 transition-all md:hover:bg-brand-500/10 md:hover:glow-brand">
        ...
        {/* Desktop image */}
        <div className="flex flex-col gap-6 px-4 py-6 md:px-6 md:py-8 border border-brand-400 rounded-b-sm border-t-0 text-sm md:text-base">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6 md:hidden">
              ...
              <div className="flex flex-col gap-2">
                <h3 className="font-bold text-lg text-surface-0">
                  {project.title}
                </h3>
